...
roctracer_status_t set_properties(
    roctracer_domain_t domain, void* properties);

template <bool CheckSuccess>
roctracer_status_t get_timestamp(
...
template <bool CheckSuccess>
roctracer_status_t enable_domain_callback(
    activity_domain_t domain, activity_rtapi_callback_t callback,
    void* arg);

template <bool CheckSuccess>
roctracer_status_t disable_domain_callback(
    activity_domain_t domain);

template <bool CheckSuccess>
roctracer_status_t enable_op_callback(
    activity_domain_t domain, uint32_t op, activity_rtapi_callback_t callback,
    void* arg);

template <bool CheckSuccess>
roctracer_status_t disable_op_callback(
...
template <bool CheckSuccess>
roctracer_status_t disable_domain_activity(
    activity_domain_t domain);

template <bool CheckSuccess>
roctracer_status_t flush_activity();

template <bool CheckSuccess>
roctracer_status_t next_record(
...
template <bool CheckSuccess>
roctracer_status_t activity_push_external_correlation_id(activity_correlation_id_t id);

template <bool CheckSuccess>
roctracer_status_t activity_pop_external_correlation_id(
